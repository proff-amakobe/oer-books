<!-- metadata: {"week": 10, "title": "Evaluating Generative AI Systems", "chapter": "Chapter 10: Evaluating Generative AI Systems", "milestone": "Evaluation Plan", "co": [3, 5], "pslo": [1, 3, 4, 6], "points": [50, 75, 50], "case": "How Anthropic Evaluates Claude"} -->
# GENERATIVE AI
...
> [SUBMISSION] Type: Discussion Board. Points: 50. Submit one initial post and two peer responses in the Week 10 Discussion item. Use Blackboard’s displayed due dates.
...
> [SUBMISSION] Type: Applied analysis. Points: 75. Submit one PDF or DOCX to Week 10 Assignment 2. Aim for 600–800 words of analysis plus the requested matrix, diagram, prompts, or evidence appendix; these artifacts are not included in the word guide.
...
> [SUBMISSION] Type: Project portfolio milestone. Points: 50. Submit a PDF or DOCX to Week 10 Project Milestone. Preserve the author’s required elements below and retain an editable copy for Week 16.
...
| Criterion | Full-credit evidence | Points |
| --- | --- | --- |
| Success definition | Addresses this author-required element specifically for the project, with reasoning and evidence consistent with prior milestones. | 15 |
| Metrics | Addresses this author-required element specifically for the project, with reasoning and evidence consistent with prior milestones. | 10 |
| Human-evaluation rubric | Addresses this author-required element specifically for the project, with reasoning and evidence consistent with prior milestones. | 15 |
| Three test cases | Addresses this author-required element specifically for the project, with reasoning and evidence consistent with prior milestones. | 10 |
| Total |  | 50 |
...
| --- | --- | --- | --- |
| What Does It Mean for a Generative AI System to Be Good? | Initial post + two replies | See Blackboard | 50 |
| Evaluation Design + LLM-as-Judge / Anthropic Analysis | Analysis + requested artifacts | See Blackboard | 75 |
| Evaluation Plan | Portfolio milestone | See Blackboard | 50 |
| TOTAL |  |  | 175 |
