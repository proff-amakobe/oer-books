<!-- metadata: {"week": 4, "title": "Working with APIs and Integration", "chapter": "Chapter 4: Working with APIs and Integration", "milestone": "Integration Architecture Diagram", "co": [2, 3], "pslo": [2, 3, 4], "points": [50, 75, 50], "case": "A Provider Outage, Worked Through"} -->
# GENERATIVE AI
...
> [SUBMISSION] Type: Discussion Board. Points: 50. Submit one initial post and two peer responses in the Week 4 Discussion item. Use Blackboard’s displayed due dates.
...
> [SUBMISSION] Type: Applied analysis. Points: 75. Submit one PDF or DOCX to Week 4 Assignment 2. Aim for 600–800 words of analysis plus the requested matrix, diagram, prompts, or evidence appendix; these artifacts are not included in the word guide.
...
> [SUBMISSION] Type: Project portfolio milestone. Points: 50. Submit a PDF or DOCX to Week 4 Project Milestone. Preserve the author’s required elements below and retain an editable copy for Week 16.
...
| Criterion | Full-credit evidence | Points |
| --- | --- | --- |
| The diagram | Addresses this author-required element specifically for the project, with reasoning and evidence consistent with prior milestones. | 20 |
| Failure handling table | Addresses this author-required element specifically for the project, with reasoning and evidence consistent with prior milestones. | 15 |
| Cost and rate-limit plan | Addresses this author-required element specifically for the project, with reasoning and evidence consistent with prior milestones. | 15 |
| Total |  | 50 |
...
| --- | --- | --- | --- |
| Reliability, Cost, and Vendor Dependence | Initial post + two replies | See Blackboard | 50 |
| Provider Outage Response and Integration Trade-off Analysis | Analysis + requested artifacts | See Blackboard | 75 |
| Integration Architecture Diagram | Portfolio milestone | See Blackboard | 50 |
| TOTAL |  |  | 175 |
