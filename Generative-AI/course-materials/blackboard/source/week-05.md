<!-- metadata: {"week": 5, "title": "Agents — AI That Takes Action", "chapter": "Chapter 5: Agents — AI That Takes Action", "milestone": "Agent Capability Plan", "co": [2, 3, 4], "pslo": [2, 3, 4, 5], "points": [10, 25, 15], "case": "Klarna's AI Customer Service Agent"} -->
# GENERATIVE AI
...
| --- | --- | --- | --- |
| How Much Autonomy Should an AI Agent Have? | Initial post + two replies | See Blackboard | 10 |
| Klarna Agent Case + Human-in-the-Loop Boundary Analysis | Analysis + requested artifacts | See Blackboard | 25 |
| Agent Capability Plan | Portfolio milestone | See Blackboard | 15 |
| TOTAL |  |  | 50 |
