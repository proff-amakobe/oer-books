<!-- metadata: {"week": 15, "title": "Deployment and the Frontier", "chapter": "Chapter 15: Deployment and the Frontier", "milestone": "Deployment Plan & Forward Look", "co": [2, 3, 4, 5], "pslo": [1, 2, 3, 4, 5, 6], "points": [10, 25, 15], "case": "A Model Deprecation, Handled Well"} -->
# GENERATIVE AI
...
> [SUBMISSION] Type: Discussion Board. Points: 10. Submit one initial post and two peer responses in the Week 15 Discussion item. Use Blackboard’s displayed due dates.
...
> [SUBMISSION] Type: Applied analysis. Points: 25. Submit one PDF or DOCX to Week 15 Assignment 2. Aim for 600–800 words of analysis plus the requested matrix, diagram, prompts, or evidence appendix; these artifacts are not included in the word guide.
...
> [SUBMISSION] Type: Project portfolio milestone. Points: 15. Submit a PDF or DOCX to Week 15 Project Milestone. Preserve the author’s required elements below and retain an editable copy for Week 16.
...
| Criterion | Full-credit evidence | Points |
| --- | --- | --- |
| Production architecture sketch | Addresses this author-required element specifically for the project, with reasoning and evidence consistent with prior milestones. | 4 |
| Deployment strategy | Addresses this author-required element specifically for the project, with reasoning and evidence consistent with prior milestones. | 3 |
| Top three monitoring signals | Addresses this author-required element specifically for the project, with reasoning and evidence consistent with prior milestones. | 5 |
| Forward look | Addresses this author-required element specifically for the project, with reasoning and evidence consistent with prior milestones. | 3 |
| Total |  | 15 |
...
| --- | --- | --- | --- |
| How Do You Design an AI System to Survive Change? | Initial post + two replies | See Blackboard | 10 |
| Model Deprecation + Production Evolution Scenario | Analysis + requested artifacts | See Blackboard | 25 |
| Deployment Plan & Forward Look | Portfolio milestone | See Blackboard | 15 |
| TOTAL |  |  | 50 |
