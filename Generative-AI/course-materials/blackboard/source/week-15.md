<!-- metadata: {"week": 15, "title": "Deployment and the Frontier", "chapter": "Chapter 15: Deployment and the Frontier", "milestone": "Deployment Plan & Forward Look", "co": [2, 3, 4, 5], "pslo": [1, 2, 3, 4, 5, 6], "points": [50, 75, 50], "case": "A Model Deprecation, Handled Well"} -->
# GENERATIVE AI

Graduate Course | First Open Edition

# Week 15 Module Guide

## Deployment and the Frontier

**Chapter:** Chapter 15: Deployment and the Frontier

**Project:** Deployment Plan & Forward Look

**Est. Total Time:** Approx. 5–7 hours across the week

## SECTION 1 — MODULE INTRODUCTION & OBJECTIVES

### 1. Week 15 Introduction & Objectives
...
| --- | --- | --- | --- |
| 1 | Creation | Design a production architecture and staged deployment strategy. | CO 2 / PSLOs 2, 3 |
| 2 | Evaluation | Evaluate migration readiness using tests, monitoring, and rollback criteria. | CO 3 / PSLOs 3, 4 |
| 3 | Evaluation | Assess ethical, legal, and security responsibilities during system evolution. | CO 4 / PSLOs 5 |
| 4 | Creation | Synthesize evidence about an emerging direction and its project implications. | CO 5 / PSLOs 1, 4, 6 |
| 5 | Evaluation | Justify a lifecycle plan that extends beyond initial launch. | CO 2 / PSLOs 2, 3 |

#### Approved CO / PSLO Alignment

This week emphasizes **CO 2, CO 3, CO 4, CO 5 / PSLOs 1, 2, 3, 4, 5, 6**. Each objective uses only the approved CO-to-PSLO mapping; a PSLO code indicates curricular alignment, not that this single week independently demonstrates the entire program outcome.
...
| Friday–Saturday | Complete the case analysis, respond to two peers, and develop Deployment Plan & Forward Look. | 100–140 min |
...
Moody Amakobe. *Generative AI: Foundations, Systems, Evaluation, and Responsible Deployment*. First Open Edition. Global Data Science Institute, 2026. **Chapter 15: Deployment and the Frontier**.

[Read the primary chapter online](https://proff-amakobe.github.io/oer-books/Generative-AI/original/15-deployment-frontier.html).

Read the introduction and learning goals, the technical discussion, **A Model Deprecation, Handled Well**, the wrap-up, and **Project Milestone: Deployment Plan & Forward Look**. Keep notes on the assumptions that make the chapter’s recommendation appropriate. The case is assigned as presented in the chapter; do not treat a reported result as a current independent benchmark.
...
**Chapters 9 and 10: Inference Optimization; AI Engineering Architecture and User Feedback**

Focus: Optimization, architecture, monitoring, orchestration, user feedback, and system evolution.
...
**Week 15 Start Here: Module Overview** — a written content page in this week’s Blackboard module. Read it before beginning the assignments. It explains what to read first, how the tasks connect, what portfolio artifact you are producing, and what deserves special attention.
...
Author-listed starting point: Any current state-of-the-industry report from a major AI research organization (search for the most recent one, these are typically published annually and are a good single-source snapshot of where the field's frontier actually sits).
...
### 4. Week 15 Assignments

The discussion develops a judgment about **How Do You Design an AI System to Survive Change**. The applied work tests that judgment against A Model Deprecation, Handled Well. The milestone carries the evidence into Deployment Plan & Forward Look.

### Assignment 1 — How Do You Design an AI System to Survive Change?

> [SUBMISSION] Type: Discussion Board. Points: 50. Submit one initial post and two peer responses in the Week 15 Discussion item. Use Blackboard’s displayed due dates.
...
**Part A — Position:** Identify a change that could invalidate your current design: model retirement, a new user group, or a changed workload.

**Part B — Comparison:** Compare two rollout strategies and explain how your evaluation and monitoring would detect a regression.

**Part C — Judgment:** Defend a migration or rollback decision and connect one frontier development to a specific future design question.
...
### Assignment 2 — Model Deprecation + Production Evolution Scenario

> [SUBMISSION] Type: Applied analysis. Points: 75. Submit one PDF or DOCX to Week 15 Assignment 2. Aim for 600–800 words of analysis plus the requested matrix, diagram, prompts, or evidence appendix; these artifacts are not included in the word guide.

Use **A Model Deprecation, Handled Well** as the anchor. Your task is to explain and test the design reasoning, not retell the case. Work through the following connected steps with informative headings.

#### Detailed Response Prompt

1. Use A Model Deprecation, Handled Well to develop a migration scenario with an old model, a replacement, and a retirement deadline. Treat model names and dates as scenario assumptions unless sourced.

2. Create a migration plan covering behavioral differences, rerunning the Week 10 tests, routing changes, communication, and rollback.

3. Compare canary and blue-green or feature-flag rollout for your stakes. Define three monitoring signals, an owner, and a stopping condition.

4. Write a forward-look paragraph connecting one frontier topic from Chapter 15 to a possible architecture change, with evidence and an explicit uncertainty.
...
### Assignment 3 — Research Assistant Milestone 15: Deployment Plan & Forward Look

> [SUBMISSION] Type: Project portfolio milestone. Points: 50. Submit a PDF or DOCX to Week 15 Project Milestone. Preserve the author’s required elements below and retain an editable copy for Week 16.
...
A strong **Deployment Plan & Forward Look** addresses the actual users and constraints from your charter. Make the decision explicit, explain the rejected alternative, and connect claims to evidence from the week’s reading or applied work. The required elements above control the submission; additional pages or a working implementation do not substitute for missing reasoning.
...
| Criterion | Full-credit evidence | Points |
| --- | --- | --- |
| Production architecture sketch | Addresses this author-required element specifically for the project, with reasoning and evidence consistent with prior milestones. | 15 |
| Deployment strategy | Addresses this author-required element specifically for the project, with reasoning and evidence consistent with prior milestones. | 10 |
| Top three monitoring signals | Addresses this author-required element specifically for the project, with reasoning and evidence consistent with prior milestones. | 15 |
| Forward look | Addresses this author-required element specifically for the project, with reasoning and evidence consistent with prior milestones. | 10 |
| Total |  | 50 |


<!-- pagebreak -->

### Week 15 Assignment Summary

| Assignment | Submission | Due | Points |
| --- | --- | --- | --- |
| How Do You Design an AI System to Survive Change? | Initial post + two replies | See Blackboard | 50 |
| Model Deprecation + Production Evolution Scenario | Analysis + requested artifacts | See Blackboard | 75 |
| Deployment Plan & Forward Look | Portfolio milestone | See Blackboard | 50 |
| TOTAL |  |  | 175 |
...
This week’s **Deployment Plan & Forward Look** becomes part 15 of the same research-assistant portfolio. Keep the submitted version, feedback, and a revised version with a short change note. In Week 16, reconcile the fifteen artifacts into one design. Do not change the project domain casually; if a change is necessary, explain its effect on earlier decisions.
