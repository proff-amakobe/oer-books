<!-- metadata: {"week": 12, "title": "AI Safety, Alignment, and Interpretability", "chapter": "Chapter 12: AI Safety, Alignment, and Interpretability", "milestone": "Red-Team Review", "co": [1, 3, 4, 5], "pslo": [1, 3, 4, 5, 6], "points": [50, 75, 50], "case": "Anthropic's Constitutional AI in Practice"} -->
# GENERATIVE AI
...
| --- | --- | --- | --- |
| Can We Know Whether a Model Is Aligned? | Initial post + two replies | See Blackboard | 50 |
| Constitutional AI + Structured Red-Team Exercise | Analysis + requested artifacts | See Blackboard | 75 |
| Red-Team Review | Portfolio milestone | See Blackboard | 50 |
| TOTAL |  |  | 175 |
