<!-- metadata: {"week": 7, "title": "Fine-tuning and Customization", "chapter": "Chapter 7: Fine-tuning and Customization", "milestone": "Customization Decision Memo", "co": [1, 2, 3, 5], "pslo": [1, 2, 3, 4, 6], "points": [50, 75, 50], "case": "Harvey AI's Legal Model Development"} -->
# GENERATIVE AI
...
> [SUBMISSION] Type: Discussion Board. Points: 50. Submit one initial post and two peer responses in the Week 7 Discussion item. Use Blackboard’s displayed due dates.
...
> [SUBMISSION] Type: Applied analysis. Points: 75. Submit one PDF or DOCX to Week 7 Assignment 2. Aim for 600–800 words of analysis plus the requested matrix, diagram, prompts, or evidence appendix; these artifacts are not included in the word guide.
...
> [SUBMISSION] Type: Project portfolio milestone. Points: 50. Submit a PDF or DOCX to Week 7 Project Milestone. Preserve the author’s required elements below and retain an editable copy for Week 16.
...
| Reasoning | Addresses this author-required element specifically for the project, with reasoning and evidence consistent with prior milestones. | 10 |
| If fine-tuning is recommended | Addresses this author-required element specifically for the project, with reasoning and evidence consistent with prior milestones. | 15 |
| If fine-tuning is not recommended | Addresses this author-required element specifically for the project, with reasoning and evidence consistent with prior milestones. | 10 |
| Total |  | 50 |
...
| --- | --- | --- | --- |
| Prompting, RAG, or Fine-Tuning? | Initial post + two replies | See Blackboard | 50 |
| Harvey Case + Customization Decision Analysis | Analysis + requested artifacts | See Blackboard | 75 |
| Customization Decision Memo | Portfolio milestone | See Blackboard | 50 |
| TOTAL |  |  | 175 |
