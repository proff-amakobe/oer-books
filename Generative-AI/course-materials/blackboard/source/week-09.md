<!-- metadata: {"week": 9, "title": "Multimodal Capabilities", "chapter": "Chapter 9: Multimodal Capabilities", "milestone": "Multimodal Extension Plan", "co": [1, 2, 3, 5], "pslo": [1, 2, 3, 4, 6], "points": [50, 75, 50], "case": "Be My Eyes and AI Visual Assistance"} -->
# GENERATIVE AI
...
> [SUBMISSION] Type: Discussion Board. Points: 50. Submit one initial post and two peer responses in the Week 9 Discussion item. Use Blackboard’s displayed due dates.
...
> [SUBMISSION] Type: Applied analysis. Points: 75. Submit one PDF or DOCX to Week 9 Assignment 2. Aim for 600–800 words of analysis plus the requested matrix, diagram, prompts, or evidence appendix; these artifacts are not included in the word guide.
...
> [SUBMISSION] Type: Project portfolio milestone. Points: 50. Submit a PDF or DOCX to Week 9 Project Milestone. Preserve the author’s required elements below and retain an editable copy for Week 16.
...
| Criterion | Full-credit evidence | Points |
| --- | --- | --- |
| Decision | Addresses this author-required element specifically for the project, with reasoning and evidence consistent with prior milestones. | 15 |
| Justification | Addresses this author-required element specifically for the project, with reasoning and evidence consistent with prior milestones. | 10 |
| If yes | Addresses this author-required element specifically for the project, with reasoning and evidence consistent with prior milestones. | 15 |
| If no | Addresses this author-required element specifically for the project, with reasoning and evidence consistent with prior milestones. | 10 |
| Total |  | 50 |
...
| --- | --- | --- | --- |
| When Is Multimodal AI Actually Necessary? | Initial post + two replies | See Blackboard | 50 |
| Be My Eyes Case + Modality/Fallback Analysis | Analysis + requested artifacts | See Blackboard | 75 |
| Multimodal Extension Plan | Portfolio milestone | See Blackboard | 50 |
| TOTAL |  |  | 175 |
