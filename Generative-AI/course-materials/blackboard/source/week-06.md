<!-- metadata: {"week": 6, "title": "Retrieval-Augmented Generation", "chapter": "Chapter 6: Retrieval-Augmented Generation", "milestone": "RAG Design Document", "co": [2, 3, 5], "pslo": [1, 2, 3, 4, 6], "points": [50, 75, 50], "case": "How Glean Built Enterprise Search with RAG"} -->
# GENERATIVE AI
...
> [SUBMISSION] Type: Discussion Board. Points: 50. Submit one initial post and two peer responses in the Week 6 Discussion item. Use Blackboard’s displayed due dates.
...
> [SUBMISSION] Type: Applied analysis. Points: 75. Submit one PDF or DOCX to Week 6 Assignment 2. Aim for 600–800 words of analysis plus the requested matrix, diagram, prompts, or evidence appendix; these artifacts are not included in the word guide.
...
> [SUBMISSION] Type: Project portfolio milestone. Points: 50. Submit a PDF or DOCX to Week 6 Project Milestone. Preserve the author’s required elements below and retain an editable copy for Week 16.
...
| Criterion | Full-credit evidence | Points |
| --- | --- | --- |
| Knowledge source | Addresses this author-required element specifically for the project, with reasoning and evidence consistent with prior milestones. | 15 |
| Chunking strategy | Addresses this author-required element specifically for the project, with reasoning and evidence consistent with prior milestones. | 10 |
| Retrieval approach | Addresses this author-required element specifically for the project, with reasoning and evidence consistent with prior milestones. | 15 |
| Worked example | Addresses this author-required element specifically for the project, with reasoning and evidence consistent with prior milestones. | 10 |
| Total |  | 50 |
...
| --- | --- | --- | --- |
| When Does RAG Increase Trust — and When Doesn't It? | Initial post + two replies | See Blackboard | 50 |
| Retrieval Failure Analysis / Glean Case | Analysis + requested artifacts | See Blackboard | 75 |
| RAG Design Document | Portfolio milestone | See Blackboard | 50 |
| TOTAL |  |  | 175 |
