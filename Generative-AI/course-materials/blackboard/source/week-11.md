<!-- metadata: {"week": 11, "title": "Advanced Techniques and Optimization", "chapter": "Chapter 11: Advanced Techniques and Optimization", "milestone": "Optimization Plan", "co": [2, 3, 5], "pslo": [1, 2, 3, 4, 6], "points": [50, 75, 50], "case": "Serving Search at Scale"} -->
# GENERATIVE AI
...
| --- | --- | --- | --- |
| When Is Optimization Worth the Complexity? | Initial post + two replies | See Blackboard | 50 |
| Serving-at-Scale Trade-off Analysis | Analysis + requested artifacts | See Blackboard | 75 |
| Optimization Plan | Portfolio milestone | See Blackboard | 50 |
| TOTAL |  |  | 175 |
