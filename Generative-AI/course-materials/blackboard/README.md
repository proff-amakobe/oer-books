...
5. Set the displayed due dates and course time zone using the actual syllabus. Schedule day groups are pacing suggestions. Configure Weeks 1–15 as 10/25/15 points and Week 16 as 10/20/20 points. Each week totals 50, producing 800 weekly points. Reserve a separate 200-point residency assessment item, for 1,000 course points. Residency is separate from the Week 16 portfolio and demonstration; its activity and rubric are outside this weekly-guide package. This follows the author’s revised grading instruction.
