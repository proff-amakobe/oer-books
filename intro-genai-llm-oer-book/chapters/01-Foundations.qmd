...
- **Discriminative task:** "Is this customer review positive or negative?" → _classifies existing content_
- **Generative task:** "Write a positive review for this product" → _creates new content_
...
- **Trigram (N=3):** Uses two previous words for more context
    - "The cat sat ___" → different predictions than just "sat ___"
...
- **Question answering:** "What causes rainbows?" → _generates scientifically accurate explanation_
- **Code generation:** "Write a Python function to calculate prime numbers" → _generates working code_
- **Creative writing:** "Write a haiku about artificial intelligence" → _creates original poetry_
...
- **Encoder:** "Je suis heureux" → _[deep understanding representation]_
- **Decoder:** _[deep understanding]_ → "I am happy"
...
5. **⚠️ Critical:** Copy immediately, you won't see it again!
...
> **⚠️ Warning:** Never commit API keys to version control. A leaked key can result in unexpected charges and security vulnerabilities.
