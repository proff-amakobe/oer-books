...
Use Google Colab. A starter notebook is provided ([hands_on_ch5.ipynb](../material/hands_on_ch5.ipynb)) that loads: (1) your fine-tuned ResNet-50 from Chapter 4 (or a fresh ImageNet-pretrained version), (2) a pre-trained YOLO model (YOLOv8 nano, the smallest variant, runs on CPU), and (3) a pre-trained Mask R-CNN model for instance segmentation visualization.
