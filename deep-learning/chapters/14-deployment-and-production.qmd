...
**Time estimate:** 45--60 minutes **Tools:** Google Colab ([hands_on_ch14.ipynb](../material/hands_on_ch14.ipynb)), pre-trained multimodal model, HuggingFace model compression tools. No training required.
