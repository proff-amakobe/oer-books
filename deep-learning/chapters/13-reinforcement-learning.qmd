...
**Time estimate:** 45--60 minutes **Tools:** Google Colab ([hands_on_ch13.ipynb](../material/hands_on_ch13.ipynb)), OpenAI Gym\'s CartPole environment, a pre-configured DQN agent. No custom implementation required.
