...
Use Google Colab with your trained ResNet-50 or EfficientNet-B0 from Chapter 4. A starter notebook is provided ([hands_on_ch6.ipynb](../material/hands_on_ch6.ipynb)) that sets up the evaluation harness, confusion matrix visualization, calibration plot, and t-SNE projection tools.
