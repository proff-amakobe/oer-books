...
![Git commit history with main and feature branches](../assets/images/ch7_fig1_git_branching.svg)
...
![Git HEAD pointing to the current branch](../assets/images/git_branch_diagram.svg){width=635px}

When you checkout a different branch, HEAD moves:
![Git HEAD after checking out a feature branch](../assets/images/git_checkout_feature_diagram.svg){width=623px}
### Branch Operations
...
![Fast-forward merge before and after](../assets/images/git_merge_before_after.svg){width=695px}
...
![Three-way Git merge creating a merge commit](../assets/images/git_three_way_merge.svg){width=618px}
...
![Git history before and after rebasing a feature branch](../assets/images/git_rebase_diagram.svg){width=690px}
...
**Visual Representation:**
![Trunk-based development with short-lived branches](../assets/images/trunk_based_development.svg){width=669px}
