...
![Cost to fix defects rising across lifecycle stages](../assets/images/cost_to_fix_curve_print.svg){width=619px}
...
![Testing pyramid with unit, integration, and end-to-end tests](../assets/images/testing_pyramid.svg){width=635px}
...
### The TDD Cycle
![Test-driven development cycle: red, green, and refactor](../assets/images/tdd_cycle.svg){width=697px}
