...
![Cost to fix defects rising across lifecycle stages](../assets/images/cost_to_fix_curve_print.svg){#fig-cost-to-fix-defects width=82%}
...
![Testing pyramid with unit, integration, and end-to-end tests](../assets/images/testing_pyramid.svg){#fig-testing-pyramid width=88%}
...
![Test-driven development cycle: red, green, and refactor](../assets/images/tdd_cycle.svg){#fig-tdd-cycle width=86%}
...
RECOMMENDATIONS
────────────────
Yes RECOMMEND RELEASE with known issues documented
