...
![UML notation for actors, use cases, system boundaries, and associations](../assets/images/ch3_fig2_usecase_elements.svg){width=58%}

### Complete Use Case Diagram Example
...
![UML activity notation for actions, decisions, flow, and initial and final nodes](../assets/images/ch3_fig4_activity_elements.svg){width=58%}

### Complete Activity Diagram Example
...
### Activity Diagram for Algorithm Logic

Activity diagrams can also model algorithms. Here's a diagram for a simple login process:

![Login activity diagram with validation, retry, session creation, and dashboard redirection](../assets/images/ch3_fig11_activity_algorithm.svg){width=70%}
...
![UML sequence notation for participants, lifelines, activations, and messages](../assets/images/ch3_fig6_sequence_elements.svg){width=62%}
...
![UML class notation showing name, attributes, operations, visibility, and types](../assets/images/ch3_fig8_class_notation.svg){width=58%}
...
![UML class relationships including association, inheritance, aggregation, composition, and dependency](../assets/images/ch3_fig9_class_relationships.svg){width=72%}
...
### Domain Models vs. Design Class Diagrams
...
### Matching Diagrams to Questions
...
### Diagrams Through the Development Lifecycle
