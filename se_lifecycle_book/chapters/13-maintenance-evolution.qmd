...
### Strategies for Legacy Evolution
...
### Managing Risk During Legacy Evolution
...
|---|---|---|
| MAJOR | Incompatible API changes that require consumers to modify code | Remove a public function; change a signature or default; drop a supported runtime |
| MINOR | Backward-compatible functionality | Add a function, optional parameter, or configuration option; deprecate an existing feature |
| PATCH | Backward-compatible corrections | Fix behavior, improve performance, apply a security patch, or correct documentation |
| Pre-release | Identify an unstable candidate | `1.0.0-alpha.1`, `1.0.0-beta.2`, `1.0.0-rc.1` |
| Build metadata | Identify a particular build | `1.0.0+20240115`, `1.0.0+build.123` |
...
### Principles for Maintainable Design
