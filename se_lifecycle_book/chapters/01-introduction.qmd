...
|---|---|---|
| Focus | Solving specific problems | Building complete systems |
| Scope | Individual tasks/features | Entire product lifecycle |
| Timeline | Short-term | Long-term (years) |
| Team size | Often individual | Usually collaborative |
| Documentation | Optional or minimal | Essential, comprehensive |
| Testing | Ad hoc | Systematic strategies |
| Process | Flexible, informal | Structured methodologies |

: Key differences between programming and software engineering {#tbl-se-vs-programming}
...
## The Role of Software Engineering in Modern Systems
...
### The Value of Good Software Engineering
...
![The Waterfall Model - sequential phases flow downward](../assets/images/ch1_fig1_waterfall_model.svg){#fig-waterfall-model width=62%}
...
![The Spiral Model - risk-driven iterative development](../assets/images/ch1_fig2_spiral_model.svg){#fig-spiral-model width=68%}
...
![The DevOps Lifecycle - continuous integration, delivery, and feedback](../assets/images/ch1_fig3_devops_lifecycle.svg){#fig-devops-lifecycle width=72%}
...
|---|---|---|---|---|
| Requirements | High stability | Low stability | Variable | Variable |
...
| Documentation | High | Low-medium | High | Medium |
| Delivery | End | Frequent | Iterative | Continuous |
| Team experience | Any | Experienced | Experienced | Experienced |

: Comparison of SDLC models across key factors {#tbl-sdlc-comparison}
...
![Feature branch created from main, developed, then merged back](../assets/images/ch1_fig4_git_branching.svg){#fig-intro-git-branching width=72%}
