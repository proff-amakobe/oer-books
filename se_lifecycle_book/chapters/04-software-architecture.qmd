...
![Layered (N-Tier) Architecture](../assets/images/ch4_fig1_layered_architecture.svg){width=72%}
...
![Model-View-Controller (MVC) Pattern](../assets/images/ch4_fig2_mvc_pattern.svg){width=72%}
...
![MVP (Model-View-Presenter) Pattern](../assets/images/ch4_fig11_mvp_pattern.svg){width=72%}

**MVVM (Model-View-ViewModel)**: Common in modern frontend frameworks. ViewModel exposes data streams that the View binds to.

![MVVM (Model-View-ViewModel) Pattern](../assets/images/ch4_fig12_mvvm_pattern.svg){width=72%}
...
![MVC Flow Example: User Login](../assets/images/ch4_fig13_mvc_flow.svg){width=72%}
...
![Microservices Architecture](../assets/images/ch4_fig3_microservices.svg){width=88%}
...
![Event-Driven Architecture](../assets/images/ch4_fig4_event_driven.svg){width=72%}
...
![CQRS (Command Query Responsibility Segregation)](../assets/images/ch4_fig14_cqrs_pattern.svg){width=72%}
...
![Monolithic Architecture](../assets/images/ch4_fig15_monolithic.svg){width=72%}
...
![Modular Monolith Architecture](../assets/images/ch4_fig16_modular_monolith.svg){width=72%}
...
![Architectural Styles Comparison](../assets/images/ch4_fig10_architecture_comparison.svg){width=88%}
...
![SOLID Principles](../assets/images/ch4_fig5_solid_principles.svg){width=72%}
...
![Design Patterns - Gang of Four (GoF) Categories](../assets/images/ch4_fig6_design_patterns_overview.svg){width=72%}
...
![Singleton Pattern](../assets/images/ch4_fig17_singleton_structure.svg){width=58%}
...
![Factory Method Pattern](../assets/images/ch4_fig8_factory_pattern.svg){width=58%}


![Factory Method Pattern Structure](../assets/images/ch4_fig18_factory_hierarchy.svg){width=58%}
...
![Builder Pattern](../assets/images/ch4_fig19_builder_pattern.svg){width=58%}
...
![Adapter Pattern](../assets/images/ch4_fig20_adapter_structure.svg){width=58%}
...
![Decorator Pattern](../assets/images/ch4_fig21_decorator_structure.svg){width=58%}
...
![Facade Pattern](../assets/images/ch4_fig22_facade_structure.svg){width=58%}
...
![Strategy Pattern](../assets/images/ch4_fig7_strategy_pattern.svg){width=58%}
...
![Observer Pattern](../assets/images/ch4_fig9_observer_pattern.svg){width=58%}
...
![Template Method Pattern](../assets/images/ch4_fig23_template_method.svg){width=58%}
...
![4+1 Architectural View Model](../assets/images/ch4_fig24_four_plus_one.svg){width=88%}
...
### Factors in Architectural Decisions
