...
![Defect Cost Increase](../assets/images/ch2_fig2_defect_cost.svg)
...
![Requirements Engineering Process](../assets/images/ch2_fig1_re_process.svg)
...
> As a user, I want the system to be fast. Avoid:

*Better:*

> As a customer, I want search results to appear within 2 seconds so that I can quickly find products. Yes

*Too technical:*

> As a developer, I want to implement caching using Redis. Avoid:

*Better:*

> As a customer, I want previously viewed products to load instantly so that I can quickly review items I've already seen. Yes

*Missing the "why":*

> As an admin, I want to export data to CSV. Avoid:

*Better:*

> As an admin, I want to export user data to CSV so that I can analyze trends in spreadsheet software I'm familiar with. Yes

![INVEST Criteria](../assets/images/ch2_fig7_invest.svg)
...
![Epics, Stories, and Tasks Hierarchy](../assets/images/ch2_fig3_epic_story_task.svg)
...
![User Story Mapping](../assets/images/ch2_fig4_story_map.svg)
...
### Writing an SRS: Section by Section
...
![Context Diagram](../assets/images/ch2_fig5_context_diagram.svg)
...
![Traceability Types](../assets/images/ch2_fig6_traceability.svg)
...
## Managing Requirements Challenges
...
![MoSCoW Prioritization](../assets/images/ch2_fig9_moscow.svg)
...
## Requirements in Practice: Tools and Techniques
