# Greedy Algorithms - When Local Optimality Leads to Global Solutions

## The Art of Making the Best Choice Now {.unnumbered}

_"The perfect is the enemy of the good." - Voltaire_

---

## Introduction: The Power of Greed {.unnumbered}
...
### When Greed Works (And When It Doesn't) {.unnumbered}
...
### The Greedy Paradigm {.unnumbered}
...
## Interval Scheduling - The Classic Greedy Problem
...
Huffman's construction produces an optimal binary prefix code for a known symbol-frequency distribution [@huffman1952minimum].
...
Dijkstra's label-setting method computes shortest paths when edge weights are nonnegative [@dijkstra1959graph].
...
## When Greedy Fails - Correctness and Limitations
...
## Project - Greedy Algorithm Toolkit
