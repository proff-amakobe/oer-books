...
## The Art of Strategic Compromise {.unnumbered}
*"The perfect is the enemy of the good." - Voltaire*
*"But in computer science, we can prove exactly how good 'good' is." - Modern CS*

---

## Introduction: The 99% Solution {.unnumbered}

Imagine you're planning a road trip to visit 50 tourist attractions across the country. Finding the absolute shortest route is an NP-hard optimization problem and can require impractical computation. But what if I told you that in just a few seconds, we could find a route with a provable bound on how far it is from the shortest possible route? Would you take it?
...
### A Real-World Success Story {.unnumbered}

UPS has used algorithmic route optimization for delivery routing, a family of problems related to the NP-hard Vehicle Routing Problem. Precise dates, guarantees, and savings figures require authoritative sourcing; they are deferred to the freshness and citation pass.

The key technical distinction is that an approximation algorithm comes with a proved worst-case quality guarantee, whereas a heuristic may work well empirically without such a guarantee.

### Why Approximation Algorithms Matter {.unnumbered}
...
### The Approximation Guarantee {.unnumbered}
...
## The Fundamentals of Approximation
...
## Vertex Cover - A Classic 2-Approximation
...
**Visual proof:** For three disjoint matching edges, the construction selects both endpoints, giving six vertices. Any cover must select at least one endpoint of each edge, so $\mathrm{OPT}\ge3$ and

$$
\frac{|C|}{\mathrm{OPT}}\le\frac{6}{3}=2.
$$
...
## Set Cover and Greedy Algorithms
...
For a minimization problem, the instance-level gap is

$$
\operatorname{gap}(I)=\frac{\operatorname{OPT}_{\mathrm{integer}}(I)}
{\operatorname{OPT}_{\mathrm{fractional}}(I)}.
$$ {#eq-integrality-gap}

The relaxation must be feasible and have a positive fractional optimum for this ratio to be defined; the problem-class gap is the supremum over valid instances.
