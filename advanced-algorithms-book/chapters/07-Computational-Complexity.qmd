# Computational Complexity & NP-Completeness - The Limits of Computing

## The Hardest Problems in Computer Science {.unnumbered}
*"P versus NP: The question that could make you a millionaire... literally."*

---

## Introduction: The Million Dollar Question {.unnumbered}
...
### A Tale of Two Problems {.unnumbered}
...
### What You'll Learn in This Chapter {.unnumbered}
...
![Nested regions show P contained in NP, NP contained in PSPACE, and PSPACE contained in EXP; the equality of P and NP remains open.](../assets/figures/chapter07/complexity-class-containment.svg){#fig-complexity-containment width=72% fig-pos="H" fig-cap="Known complexity-class containments do not resolve whether P equals NP."}
...
Cook established the NP-completeness of satisfiability, providing the starting point for reductions among computational problems [@cook1971complexity].

This problem is called **SAT** (Boolean Satisfiability).

Karp then gave polynomial reductions establishing NP-completeness for a broad collection of combinatorial problems [@karp1972reducibility]. These problems are called **NP-complete**.
