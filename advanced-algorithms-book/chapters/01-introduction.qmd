...
So we can choose c = 10 and n₀ = 1, proving that 3n² + 5n + 2 = O(n²). ✓
...
**Example:** Let's prove that 3n² + 5n + 2 = Ω(n²).
...
**Example:** Since we proved both 3n² + 5n + 2 = O(n²) and 3n² + 5n + 2 = Ω(n²), we can conclude:
...
#### Misconception 3: "Best case = O(), Worst case = Ω()"

❌ **Wrong thinking:** "QuickSort's best case is O(n log n) and worst case is Ω(n²)."

✅ **Correct thinking:** "QuickSort's best case is Θ(n log n) and worst case is Θ(n²). Each case has its own Big-O, Big-Ω, and Big-Θ."

**Correct analysis of QuickSort:**

- **Best case:** Θ(n log n) - this means O(n log n) AND Ω(n log n)
- **Average case:** Θ(n log n)
- **Worst case:** Θ(n²) - this means O(n²) AND Ω(n²)

#### Misconception 4: "Asymptotic analysis applies to small inputs"

❌ **Wrong thinking:** "This O(n²) algorithm is slow even on 5 elements."
...
```{.algorithm chapter=1}
O(1) < O(log log n) < O(log n) < O(n^(1/3)) < O(√n) < O(n)
...
**Part B:** Prove using formal definitions that 5n³ + 3n² + 2n + 1 = Ω(n³)
